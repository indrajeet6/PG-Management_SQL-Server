           ...
           <h4 style="text-align:center"> Father's Details</h4>
            <asp:Panel runat="server">
                <table>
                    ...
                    <tr>
                        <td><asp:Label ID="Label20" Text="Rent Amount" runat="server"></asp:Label></td>
                        <td><asp:TextBox ID="txtTenantRent"  runat="server"></asp:TextBox></td>
                    </tr>
                </table>
            </asp:Panel>
        ...
        <div style="float:left">
            ...
            <asp:Panel runat="server">
                <table>
                    ...
                    <tr>
                        <td colspan="2"><asp:Button ID="Submit" Text="Add New Tenant Details" OnClick="Add_New_Tenant_Details" runat="server"/></td>
                    </tr>
                </table>
            </asp:Panel>
