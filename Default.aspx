...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="table-responsive" >
        <asp:gridview HorizontalAlign="Justify" id="GridView1" runat="server" autogeneratecolumns="true" CssClass="table table-striped table-bordered table-hover table-condensed" >
        </asp:gridview>
    </div>
    <div>
